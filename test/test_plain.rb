...
class TestPlain < Test::Unit::TestCase
  ...
  def test_import_paths
    # FIXME: import is momentarily broken, focusing on other things
    #
    # @s.import EmptyClass
    ...
    # assert_equal OneNested::FirstClass.object_id, eval("OneNested::FirstClass.object_id")
    # assert_equal eval("String.object_id"), eval("OneNested::FirstClass.name.class.object_id")
